 ...
 void IntCtrl_init(const INTCTRL_ConfigType* ConfigPtr)
{
	...
	for(int i= 0; i< INTCTRL_NUMBER_OF_INTERRUPTS; i++)
	{
		...
		{	
			...
			if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_MEMORY_MANAGEMENT_FAULT)
			{
				INTCTRL_SYSTEM_PRI1_REG = (INTCTRL_SYSTEM_PRI1_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_BUS_FAULT)
			{
				INTCTRL_SYSTEM_PRI1_REG = (INTCTRL_SYSTEM_PRI1_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_USAGE_FAULT)
			{
				INTCTRL_SYSTEM_PRI1_REG = (INTCTRL_SYSTEM_PRI1_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}	
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_SVCALL)
			{
			  INTCTRL_SYSTEM_PRI2_REG = (INTCTRL_SYSTEM_PRI2_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_PENDSV)
			{
				INTCTRL_SYSTEM_PRI3_REG = (INTCTRL_SYSTEM_PRI3_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_PENDSV)
			{
				INTCTRL_SYSTEM_PRI3_REG = (INTCTRL_SYSTEM_PRI3_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_SYSTICK)
			{
			...
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_UART2)
			{
				INTCTRL_PRI8_REG = (INTCTRL_PRI8_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_SSI1)
			{
				INTCTRL_PRI8_REG = (INTCTRL_PRI8_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_16_32_BIT_TIMER_3A)
			{
				INTCTRL_PRI8_REG = (INTCTRL_PRI8_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_16_32_BIT_TIMER_3B)
			{
				INTCTRL_PRI9_REG = (INTCTRL_PRI9_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_I2C1)
			{
				INTCTRL_PRI9_REG = (INTCTRL_PRI9_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_QEI1)
			{
				INTCTRL_PRI9_REG = (INTCTRL_PRI9_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_CAN0)
			{
				INTCTRL_PRI9_REG = (INTCTRL_PRI9_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_CAN1)
			{
				INTCTRL_PRI10_REG = (INTCTRL_PRI10_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_HIBERNATION_MODULE)
			{
				INTCTRL_PRI10_REG = (INTCTRL_PRI10_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_USB)
			{
				INTCTRL_PRI11_REG = (INTCTRL_PRI11_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_PWM_GENERATOR_3)
			{
				INTCTRL_PRI11_REG = (INTCTRL_PRI11_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_mDMA_SOFTWARE)
			{
				INTCTRL_PRI11_REG = (INTCTRL_PRI11_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_mDMA_ERROR)
			{
				INTCTRL_PRI11_REG = (INTCTRL_PRI11_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_ADC1_SEQUENCE_0)
			{
				INTCTRL_PRI12_REG = (INTCTRL_PRI12_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_ADC1_SEQUENCE_1)
			{
				INTCTRL_PRI12_REG = (INTCTRL_PRI12_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_ADC1_SEQUENCE_2)
			{
				INTCTRL_PRI12_REG = (INTCTRL_PRI12_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_ADC1_SEQUENCE_3)
			{
				INTCTRL_PRI12_REG = (INTCTRL_PRI12_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_SSI2)
			{
				INTCTRL_PRI14_REG = (INTCTRL_PRI14_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_SSI3)
			{
				INTCTRL_PRI14_REG = (INTCTRL_PRI14_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_UART3)
			{
				INTCTRL_PRI14_REG = (INTCTRL_PRI14_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_UART4)
			{
				INTCTRL_PRI15_REG = (INTCTRL_PRI15_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_UART5)
			{
				INTCTRL_PRI15_REG = (INTCTRL_PRI15_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_UART6)
			{
				INTCTRL_PRI15_REG = (INTCTRL_PRI15_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_UART7)
			{
				INTCTRL_PRI15_REG = (INTCTRL_PRI15_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_I2C2)
			{
				INTCTRL_PRI17_REG = (INTCTRL_PRI17_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_I2C3)
			{
				INTCTRL_PRI17_REG = (INTCTRL_PRI17_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_16_32_BIT_TIMER_4A)
			{
				INTCTRL_PRI17_REG = (INTCTRL_PRI17_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_16_32_BIT_TIMER_4B)
			{
				INTCTRL_PRI17_REG = (INTCTRL_PRI17_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_16_32_BIT_TIMER_5A)
			{
				INTCTRL_PRI23_REG = (INTCTRL_PRI23_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_16_32_BIT_TIMER_5B)
			{
				INTCTRL_PRI23_REG = (INTCTRL_PRI23_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_0A)
			{
				INTCTRL_PRI23_REG = (INTCTRL_PRI23_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_0B)
			{
				INTCTRL_PRI23_REG = (INTCTRL_PRI23_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_1A)
			{
				INTCTRL_PRI24_REG = (INTCTRL_PRI24_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_1B)
			{
				INTCTRL_PRI24_REG = (INTCTRL_PRI24_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_2A)
			{
				INTCTRL_PRI24_REG = (INTCTRL_PRI24_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_2B)
			{
				INTCTRL_PRI24_REG = (INTCTRL_PRI24_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_3A)
			{
				INTCTRL_PRI25_REG = (INTCTRL_PRI25_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_3B)
			{
				INTCTRL_PRI25_REG = (INTCTRL_PRI25_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_4A)
			{
				INTCTRL_PRI25_REG = (INTCTRL_PRI25_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_4B)
			{
				INTCTRL_PRI25_REG = (INTCTRL_PRI25_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}	
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_5A)
			{
				INTCTRL_PRI26_REG = (INTCTRL_PRI26_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_32_64_BIT_TIMER_5B)
			{
				INTCTRL_PRI26_REG = (INTCTRL_PRI26_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_SYSTEM_EXCEPTION_IMPRECISE)
			{
				INTCTRL_PRI26_REG = (INTCTRL_PRI26_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_PWM1_GENERATOR_0)
			{
				INTCTRL_PRI31_REG = (INTCTRL_PRI31_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_PWM1_GENERATOR_1)
			{
				INTCTRL_PRI31_REG = (INTCTRL_PRI31_REG & INTCTRL_PRIORITY_MASK_START_POSITION_13) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_13);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_PWM1_GENERATOR_2)
			{
				INTCTRL_PRI31_REG = (INTCTRL_PRI31_REG & INTCTRL_PRIORITY_MASK_START_POSITION_21) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_21);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_PWM1_GENERATOR_3)
			{
				INTCTRL_PRI31_REG = (INTCTRL_PRI31_REG & INTCTRL_PRIORITY_MASK_START_POSITION_29) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_29);
			}
			else if(INTCTRL_IntPtr[i].Exception_Type == INTCTRL_PWM1_FAULT)
			{
				INTCTRL_PRI32_REG = (INTCTRL_PRI32_REG & INTCTRL_PRIORITY_MASK_START_POSITION_5) | (INTCTRL_IntPtr[i].Int_Group_Priority << INTCTRL_PRIORITY_START_POSITION_5);
			}
